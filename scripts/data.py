...
def get_sense_data():
    ...
    sense_data.append(floor(sense.get_temperature()))
    sense_data.append(floor(sense.get_pressure()))
    sense_data.append(floor(sense.get_humidity()))
    # Get colour sensor data (version 2 Sense HAT only)
    #red, green, blue, clerar=sense.colour.colour
